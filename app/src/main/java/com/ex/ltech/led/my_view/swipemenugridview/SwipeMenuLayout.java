...
public class SwipeMenuLayout extends FrameLayout
{
  ...
  private void init()
  {
    ...
    label186: for (this.mOpenScroller = ScrollerCompat.create(getContext(), this.mOpenInterpolator); ; this.mOpenScroller = ScrollerCompat.create(getContext()))
    {
 ...
 * Qualified Name:     com.ex.ltech.led.my_view.swipemenugridview.SwipeMenuLayout
