...
public class MyAlertDialog12 extends AlertDialog
{
  private View.OnClickListener btn_listener = new View.OnClickListener()
  {
    public void onClick(View paramView)
    {
      ...
      case 2131559070:
        do
          return;
        while (MyAlertDialog12.this.myListener == null);
        MyAlertDialog12.this.myListener.onMyEditAlertDialogBtnClick(paramView, MyAlertDialog12.this.et_my_edit_alertdialog.getText().toString());
        MyAlertDialog12.this.dismiss();
        return;
      case 2131559069:
      }
      MyAlertDialog12.this.dismiss();
  ...
  public MyAlertDialog12(Context paramContext)
  {
    super(paramContext);
    this.context = paramContext;
  }

  public MyAlertDialog12(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
    this.context = paramContext;
  }

  public MyAlertDialog12(Context paramContext, boolean paramBoolean, DialogInterface.OnCancelListener paramOnCancelListener)
  {
 ...
 * Qualified Name:     com.ex.ltech.led.my_view.MyAlertDialog12
