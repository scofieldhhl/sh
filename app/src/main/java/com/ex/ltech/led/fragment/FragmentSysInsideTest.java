...
public class FragmentSysInsideTest extends MasterFragment
  implements View.OnClickListener, SeekBar.OnSeekBarChangeListener, AdapterView.OnItemClickListener
{
  ...
  public void onClick(View paramView)
  {
    ...
    startFragment(new Request(FragmentTimingColorTest.class));
  }
 ...
 * Qualified Name:     com.ex.ltech.led.fragment.FragmentSysInsideTest
