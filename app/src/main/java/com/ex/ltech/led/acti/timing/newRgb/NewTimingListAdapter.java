...
public class NewTimingListAdapter extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      paramView = LayoutInflater.from(this.pct).inflate(R.layout.lv_item_act_timing, null);
      localHolder.tv_act_timing_time = ((TextView)paramView.findViewById(R.id.tv_act_timing_time));
      localHolder.tv_act_timing_swich_status = ((TextView)paramView.findViewById(R.id.tv_act_timing_swich_status));
      localHolder.tv_act_timing_mode = ((TextView)paramView.findViewById(R.id.tv_act_timing_mode));
      localHolder.tv_act_timing_repeat = ((TextView)paramView.findViewById(R.id.tv_act_timing_repeat));
      localHolder.csv_act_timing = ((ColorSeletedView)paramView.findViewById(R.id.csv_act_timing));
      localHolder.tb_act_timing_swich = ((ToggleButton)paramView.findViewById(R.id.tb_act_timing_swich));
      localHolder.who_timing = ((TextView)paramView.findViewById(R.id.who_timing));
