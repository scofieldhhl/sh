  ...
  implements NewTimingListAdapter.OnListVSwichChangeListener
{
  ...
  private void init()
  {
    ...
    this.lv_act_timing.setOnScrollListener(new OnScrollListener()
    {
  ...
  {
    /*final ProgressDialog localProgressDialog = ProgressDialog.show(this, "", getString(R.string.time_sending), true);
    localProgressDialog.setCancelable(true);
    ...
    this.bussines.setSendCmdListener(new NewRgbTimingBussines.SendCmdListener()
    {
      public void onSendFailde()
      {
        TimingVo localTimingVo = (TimingVo)ActNewRgbTiming.this.vos.get(paramInt);
        if (!paramBoolean);
  ...
  protected void onResume()
  {
    ...
    if (!this.isActivityResult)
    {
      ...
      this.handler.postDelayed(new Runnable()
      {
        public void run()
        {
          ActNewRgbTiming.this.getTimeDialog = ProgressDialog.show(ActNewRgbTiming.this, "",
                  ActNewRgbTiming.this.getString(R.string.get_time_data), false);
