...
public class MyEditAlertDialog2 extends AlertDialog
{
  private View.OnClickListener btn_listener = new View.OnClickListener()
  {
    public void onClick(View paramView)
    {
      ...
      case 2131559070:
        do
          return;
        while (MyEditAlertDialog2.this.myListener == null);
        MyEditAlertDialog2.this.myListener.onMyEditAlertDialogBtnClick(paramView, MyEditAlertDialog2.this.et_my_edit_alertdialog.getText().toString());
  ...
  public MyEditAlertDialog2(Context paramContext)
  {
    super(paramContext);
    this.context = paramContext;
  }

  public MyEditAlertDialog2(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
    this.context = paramContext;
  }

  public MyEditAlertDialog2(Context paramContext, boolean paramBoolean, DialogInterface.OnCancelListener paramOnCancelListener)
  {
 ...
 * Qualified Name:     com.ex.ltech.led.my_view.MyEditAlertDialog2
