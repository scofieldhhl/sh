  ...
  private View.OnClickListener btn_listener = new View.OnClickListener()
  {
    public void onClick(View paramView)
    {
      ...
      default:
        return;
      case 2131559407:
        MyAlertDialog.this.h.postDelayed(new Runnable(paramView)
        {
          public void run()
          {
            if (MyAlertDialog.this.myListener != null)
            {
              MyAlertDialog.this.myListener.onClick(this.val$v, true);
      ...
      MyAlertDialog.this.h.postDelayed(new Runnable(paramView)
      {
        public void run()
        {
          if (MyAlertDialog.this.myListener != null)
          {
            MyAlertDialog.this.myListener.onClick(this.val$v, false);
            MyAlertDialog.this.dismiss();
          }
        }
      }
 ...
 * Qualified Name:     com.ex.ltech.led.my_view.MyAlertDialog
