...
public class MyTimePickerView2 extends View
{
  ...
  Handler updateHandler = new Handler()
  {
    ...
    {
      if (Math.abs(MyTimePickerView2.this.mMoveLen) < 2.0F)
      {
        MyTimePickerView2.access$002(MyTimePickerView2.this, 0.0F);
        if (MyTimePickerView2.this.mTask != null)
        {
          MyTimePickerView2.this.mTask.cancel();
          MyTimePickerView2.access$102(MyTimePickerView2.this, null);
          MyTimePickerView2.this.performSelect();
        }
      }
      while (true)
      {
        MyTimePickerView2.this.invalidate();
        return;
        MyTimePickerView2.access$002(MyTimePickerView2.this, MyTimePickerView2.this.mMoveLen - 2.0F * (MyTimePickerView2.this.mMoveLen / Math.abs(MyTimePickerView2.this.mMoveLen)));
      }
    }
  };
  private String value;

  public MyTimePickerView2(Context paramContext)
  {
    super(paramContext);
    init();
  }

  public MyTimePickerView2(Context paramContext, AttributeSet paramAttributeSet)
  {
  ...
  private void doDown(MotionEvent paramMotionEvent)
  {
    if (this.mSelectListener != null)
      this.mSelectListener.onDown();
    if (this.mTask != null)
    {
      this.mTask.cancel();
      this.mTask = null;
    }
    this.mLastDownY = paramMotionEvent.getX();
  }

  private void doMove(MotionEvent paramMotionEvent)
  {
    this.mMoveLen += paramMotionEvent.getX() - this.mLastDownY;
  ...
  private void drawData(Canvas paramCanvas)
  {
    ...
    {
      return;
      float f1 = parabola(this.mViewWidth / 4.0F, this.mMoveLen);
      ...
      (float)(this.mViewWidth / 2.0D);
      float f3 = (float)(this.mViewWidth / 2.0D + this.mMoveLen);
      Paint.FontMetricsInt localFontMetricsInt = this.mPaint.getFontMetricsInt();
      float f4 = (float)(f3 - (localFontMetricsInt.bottom / 2.0D + localFontMetricsInt.top / 2.0D));
      this.value = ((String)this.mDataList.get(this.mCurrentSelected));
      paramCanvas.drawText((String)this.mDataList.get(this.mCurrentSelected), f4, (float)(this.mViewHeight / 2.0D), this.mPaint2);
  ...
  private void drawOtherText(Canvas paramCanvas, int paramInt1, int paramInt2)
  {
    ...
    float f2 = parabola(this.mViewWidth / 4.0F, f1);
    ...
    float f4 = (float)(this.mViewWidth / 2.0D + f1 * paramInt2);
    Paint.FontMetricsInt localFontMetricsInt = this.mPaint.getFontMetricsInt();
    float f5 = (float)(f4 - (localFontMetricsInt.bottom / 2.0D + localFontMetricsInt.top / 2.0D));
    paramCanvas.drawText((String)this.mDataList.get(this.mCurrentSelected + paramInt2 * paramInt1), f5, (float)(this.mViewHeight / 2.0D), this.mPaint);
  }
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    this.mMaxTextSize = (this.mViewWidth / 10.0F);
  ...
  {
    System.out.println("doMove:" + paramMotionEvent.getActionMasked());
 ...
 * Qualified Name:     com.ex.ltech.led.my_view.MyTimePickerView2
