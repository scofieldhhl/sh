  ...
  implements ScaleGestureDetector.OnScaleGestureListener, View.OnTouchListener, ViewTreeObserver.OnGlobalLayoutListener
{
  ...
  public ClipZoomImageView(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    this.mGestureDetector = new GestureDetector(paramContext, new GestureDetector.SimpleOnGestureListener()
    {
      ...
      {
        if (ClipZoomImageView.this.isAutoScale == true)
          return true;
        float f1 = paramMotionEvent.getX();
        float f2 = paramMotionEvent.getY();
        if (ClipZoomImageView.this.getScale() < ClipZoomImageView.SCALE_MID)
        {
          ClipZoomImageView.this.postDelayed(new ClipZoomImageView.AutoScaleRunnable(ClipZoomImageView.this, ClipZoomImageView.SCALE_MID, f1, f2), 16L);
          ClipZoomImageView.access$002(ClipZoomImageView.this, true);
          return true;
        }
        ClipZoomImageView.this.postDelayed(new ClipZoomImageView.AutoScaleRunnable(ClipZoomImageView.this, ClipZoomImageView.this.initScale, f1, f2), 16L);
        ClipZoomImageView.access$002(ClipZoomImageView.this, true);
        return true;
      }
    });
  ...
  private void checkBorder()
  {
    ...
    int i = getWidth();
    int j = getHeight();
    Log.e(TAG, "rect.width() =  " + localRectF.width() + " , width - 2 * mHorizontalPadding =" + (i - 2 * this.mHorizontalPadding));
    boolean bool1 = 0.01D + localRectF.width() < i - 2 * this.mHorizontalPadding;
    float f1 = 0.0F;
    if (!bool1)
    {
    ...
    boolean bool2 = 0.01D + localRectF.height() < j - 2 * this.mVerticalPadding;
    float f2 = 0.0F;
    if (!bool2)
    {
  ...
  public Bitmap clip()
  {
    ...
    return Bitmap.createBitmap(localBitmap, this.mHorizontalPadding, this.mVerticalPadding, getWidth() - 2 * this.mHorizontalPadding, getWidth() - 2 * this.mHorizontalPadding);
  }
  ...
  public void onGlobalLayout()
  {
    ...
    float f = 1.0F;
    if ((k < getWidth() - 2 * this.mHorizontalPadding) && (m > getHeight() - 2 * this.mVerticalPadding))
      f = (1.0F * getWidth() - 2 * this.mHorizontalPadding) / k;
    if ((m < getHeight() - 2 * this.mVerticalPadding) && (k > getWidth() - 2 * this.mHorizontalPadding))
      f = (1.0F * getHeight() - 2 * this.mVerticalPadding) / m;
    if ((k < getWidth() - 2 * this.mHorizontalPadding) && (m < getHeight() - 2 * this.mVerticalPadding))
      f = Math.max((1.0F * getWidth() - 2 * this.mHorizontalPadding) / k, (1.0F * getHeight() - 2 * this.mVerticalPadding) / m);
    this.initScale = f;
  ...
  public boolean onScale(ScaleGestureDetector paramScaleGestureDetector)
  {
    ...
    do
      return true;
    while (((f1 >= SCALE_MAX) || (f2 <= 1.0F)) && ((f1 <= this.initScale) || (f2 >= 1.0F)));
    ...
    implements Runnable
  {
    ...
    public AutoScaleRunnable(float paramFloat1, float paramFloat2, float arg4)
    {
    ...
    public void run()
    {
      ...
      if (((this.tmpScale > 1.0F) && (f1 < this.mTargetScale)) || ((this.tmpScale < 1.0F) && (this.mTargetScale < f1)))
      {
      ...
      ClipZoomImageView.this.checkBorder();
      ClipZoomImageView.this.setImageMatrix(ClipZoomImageView.this.mScaleMatrix);
      ClipZoomImageView.access$002(ClipZoomImageView.this, false);
    }
  }
}

/* Location:           E:\android逆向助手2——2\com.ex.ltech.led_1.9.7_197_dex2jar.jar
 * Qualified Name:     com.ex.ltech.led.my_view.ClipZoomImageView
