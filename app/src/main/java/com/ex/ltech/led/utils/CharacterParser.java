...
public class CharacterParser
{
  ...
  public static int firstIsLetter(String paramString)
  {
    int i = getChsAscii(paramString.substring(0, 1));
    if ((i >= 65) && (i <= 90))
      return 1;
    if ((i >= 97) && (i <= 122))
      return -1;
  ...
  public static int getChsAscii(String paramString)
  {
    ...
    int k = 256 + arrayOfByte[0];
    int m = arrayOfByte[1];
    return m + 256 + k * 256 - 65536;
  }

  public static String getFirstLetter(String paramString)
  {
    return getSpellByAscii(getChsAscii(paramString.substring(0, 1)));
  }

  public static String getFirstUpperLetter(String paramString)
  {
    return getFirstLetter(paramString).toUpperCase();
  }
  ...
  public static String getFullSpell(String paramString)
  {
    ...
    for (int i = 0; i < paramString.length(); i++)
    {
      ...
      str1 = str1 + getSpellByAscii(getChsAscii(str2));
    }
    return str1;
  }
  ...
  public static String getSpellByAscii(int paramInt)
  {
    ...
    if ((paramInt < -20319) || (paramInt > -10247))
      return null;
    for (int i = -1 + pyvalue.length; ; i--)
    {
      str = null;
      if (i < 0)
        break;
      if (paramInt < pyvalue[i])
        continue;
      str = pystr[i];
      break;
    }
  ...
  public void setResource(StringBuilder paramStringBuilder)
  {
    this.resource = paramStringBuilder;
  }
}

/* Location:           E:\android逆向助手2——2\com.ex.ltech.led_1.9.7_197_dex2jar.jar
 * Qualified Name:     com.ex.ltech.led.utils.CharacterParser
