...
public class MyEditAlertDialog3 extends AlertDialog
{
  private View.OnClickListener btn_listener = new View.OnClickListener()
  {
    public void onClick(View paramView)
    {
      ...
      case 2131559070:
        do
          return;
        while (MyEditAlertDialog3.this.myListener == null);
        MyEditAlertDialog3.this.myListener.onMyEditAlertDialogBtnClick(paramView, MyEditAlertDialog3.this.et_my_edit_alertdialog.getText().toString());
        MyEditAlertDialog3.this.dismiss();
        return;
      case 2131559069:
      }
      MyEditAlertDialog3.this.dismiss();
  ...
  public MyEditAlertDialog3(Context paramContext)
  {
    super(paramContext);
    this.context = paramContext;
  }

  public MyEditAlertDialog3(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
    this.context = paramContext;
  }

  public MyEditAlertDialog3(Context paramContext, boolean paramBoolean, DialogInterface.OnCancelListener paramOnCancelListener)
  {
 ...
 * Qualified Name:     com.ex.ltech.led.my_view.MyEditAlertDialog3
