...
public class MyAlertDialog8 extends AlertDialog
{
  private View.OnClickListener btn_listener = new View.OnClickListener()
  {
    public void onClick(View paramView)
    {
      ...
      default:
        return;
      case 2131558621:
        MyAlertDialog8.this.h.postDelayed(new Runnable()
        {
          public void run()
          {
  ...
  public MyAlertDialog8(Context paramContext)
  {
    super(paramContext);
    this.context = paramContext;
  }

  public MyAlertDialog8(Context paramContext, int paramInt)
  {
    super(paramContext, paramInt);
    this.context = paramContext;
  }

  public MyAlertDialog8(Context paramContext, boolean paramBoolean, DialogInterface.OnCancelListener paramOnCancelListener)
  {
 ...
 * Qualified Name:     com.ex.ltech.led.my_view.MyAlertDialog8
