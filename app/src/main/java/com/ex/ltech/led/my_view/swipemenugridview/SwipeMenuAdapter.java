  ...
  implements WrapperListAdapter, SwipeMenuView.OnSwipeItemClickListener
{
  ...
  private SwipeMenuGridView.OnMenuItemClickListener onMenuItemClickListener;
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    if (paramView == null)
    {
      ...
      SwipeMenuView localSwipeMenuView = new SwipeMenuView(localSwipeMenu, (SwipeMenuGridView)paramViewGroup);
      localSwipeMenuView.setOnSwipeItemClickListener(this);
      SwipeMenuGridView localSwipeMenuGridView = (SwipeMenuGridView)paramViewGroup;
      SwipeMenuLayout localSwipeMenuLayout2 = new SwipeMenuLayout(localView, localSwipeMenuView, localSwipeMenuGridView.getCloseInterpolator(), localSwipeMenuGridView.getOpenInterpolator());
  ...
  public void setOnMenuItemClickListener(SwipeMenuGridView.OnMenuItemClickListener paramOnMenuItemClickListener)
  {
 ...
 * Qualified Name:     com.ex.ltech.led.my_view.swipemenugridview.SwipeMenuAdapter
