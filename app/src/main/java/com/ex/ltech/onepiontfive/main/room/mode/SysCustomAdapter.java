...
public class SysCustomAdapter extends BaseAdapter
{
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    label220: label227: for (int j = this.pct.getResources().getColor(R.color.gray); ; j = this.pct.getResources().getColor(2131492997))
    {
 ...
 * Qualified Name:     com.ex.ltech.onepiontfive.main.room.mode.SysCustomAdapter
