...
{
  private List<SensorDelay> itemVos;
  private Activity pct;

  public DelayAdapter(Activity paramActivity, List<SensorDelay> paramList)
  {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    if (paramView == null)
    {
      ...
      SensorDelay localSensorDelay = (SensorDelay)this.itemVos.get(paramInt);
      localHolder.tv_act_repeat_day.setText(localSensorDelay.getName());
 ...
 * Qualified Name:     com.ex.ltech.onepiontfive.main.room.sensor.DelayAdapter
