...
public class Light
{
  boolean allOnOff;
  int brtProgress;
  public List<Light> innerDvcVos = new ArrayList();
  ...
  public List<Light> getInnerDvcVos()
  {
  ...
  public void setInnerDvcVos(List<Light> paramList)
  {
    this.innerDvcVos.clear();
    this.innerDvcVos.addAll(paramList);
  }
 ...
 * Qualified Name:     com.ex.ltech.onepiontfive.main.vo.Light
