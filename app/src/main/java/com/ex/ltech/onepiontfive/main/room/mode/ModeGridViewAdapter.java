  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup)
  {
    ...
    case 2:
      while (true)
      {
        ...
        {
          k = i;
          label282: localImageView2.setBackgroundResource(k);
    ...
    if (localModeVo.isSeleted())
    {
      label461: localImageView1.setBackgroundResource(i);
      if (!localModeVo.isSingleSeleted())
        break label516;
    }
 ...
 * Qualified Name:     com.ex.ltech.onepiontfive.main.room.mode.ModeGridViewAdapter
