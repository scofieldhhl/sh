...
public class ProjecterFragment1 extends Fragment
  implements View.OnClickListener, View.OnLongClickListener
{
  ...
  private void setDirverListener()
  {
    this.ok.setOnTouchListener(new View.OnTouchListener()
    {
      public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
      {
        ...
        while (true)
        {
          if ((j | i) == 0)
            break label53;
          ProjecterFragment1.this.iv_dirver.setBackgroundResource(2130903575);
          return false;
          j = 0;
          break;
          label48: i = 0;
        }
        label53: ProjecterFragment1.this.iv_dirver.setBackgroundResource(2130903578);
        return false;
      }
    });
    this.up.setOnTouchListener(new View.OnTouchListener()
    {
      public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
      {
        ...
        label53: ProjecterFragment1.this.iv_dirver.setBackgroundResource(2130903580);
        return false;
      }
    });
    this.down.setOnTouchListener(new View.OnTouchListener()
    {
      public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
      {
        ...
        label53: ProjecterFragment1.this.iv_dirver.setBackgroundResource(2130903576);
        return false;
      }
    });
    this.left.setOnTouchListener(new View.OnTouchListener()
    {
      public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
      {
        ...
        label53: ProjecterFragment1.this.iv_dirver.setBackgroundResource(2130903577);
        return false;
      }
    });
    this.right.setOnTouchListener(new View.OnTouchListener()
    {
      public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
      {
        ...
        label53: ProjecterFragment1.this.iv_dirver.setBackgroundResource(2130903579);
        return false;
      }
    });
  }
  ...
  {
    this.mRootView = paramLayoutInflater.inflate(2130968772, paramViewGroup, false);
 ...
 * Qualified Name:     com.ex.ltech.hongwai.atRcs.fragment.ProjecterFragment1
