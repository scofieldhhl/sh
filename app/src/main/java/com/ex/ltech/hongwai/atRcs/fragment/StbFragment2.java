...
public class StbFragment2 extends Fragment
{
  ...
  public class ItFtFanRc2Adapter extends BaseAdapter
  {
    ...
    private void initializeViews(IrData.IrKey paramIrKey, ViewHolder paramViewHolder, int paramInt, View paramView)
    {
      ...
      paramViewHolder.btDiy.setOnTouchListener(new StbFragment2.MyOnTouchListener(StbFragment2.this, paramViewHolder.btDiy));
      paramViewHolder.btDiy.setOnClickListener(new View.OnClickListener(paramIrKey)
      {
        public void onClick(View paramView)
        {
          StbFragment2.this.pat.sendRcCodeByChineseName(this.val$irKey.fname);
        }
      });
      paramViewHolder.btDiy.setOnLongClickListener(new View.OnLongClickListener(paramIrKey)
      {
        ...
        {
          StbFragment2.this.pat.showLearn(this.val$irKey.fname);
          return false;
        }
      });
    }
    ...
    public int getCount()
    {
      return StbFragment2.this.fanNotNormalKey.size();
    }

    public IrData.IrKey getItem(int paramInt)
    {
      return (IrData.IrKey)StbFragment2.this.fanNotNormalKey.get(paramInt);
    }
 ...
 * Qualified Name:     com.ex.ltech.hongwai.atRcs.fragment.StbFragment2
