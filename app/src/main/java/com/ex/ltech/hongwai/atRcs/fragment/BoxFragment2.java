...
public class BoxFragment2 extends Fragment
{
  ...
  public int notifyDataSetChangedAdt()
  {
    ...
    return this.fanNotNormalKey.size();
  }
  ...
  public class ItFtFanRc2Adapter extends BaseAdapter
  {
    ...
    private void initializeViews(IrData.IrKey paramIrKey, ViewHolder paramViewHolder, int paramInt, View paramView)
    {
      ...
      paramViewHolder.btDiy.setOnTouchListener(new BoxFragment2.MyOnTouchListener(BoxFragment2.this, paramViewHolder.btDiy));
      paramViewHolder.btDiy.setOnClickListener(new View.OnClickListener(paramIrKey)
      {
        public void onClick(View paramView)
        {
          BoxFragment2.this.pat.sendRcCodeByChineseName(this.val$irKey.fname);
        }
      });
      paramViewHolder.btDiy.setOnLongClickListener(new View.OnLongClickListener(paramIrKey)
      {
        ...
        {
          BoxFragment2.this.pat.showLearn(this.val$irKey.fname);
          return false;
        }
      });
    }
    ...
    public int getCount()
    {
      return BoxFragment2.this.fanNotNormalKey.size();
    }

    public IrData.IrKey getItem(int paramInt)
    {
      return (IrData.IrKey)BoxFragment2.this.fanNotNormalKey.get(paramInt);
    }
 ...
 * Qualified Name:     com.ex.ltech.hongwai.atRcs.fragment.BoxFragment2
