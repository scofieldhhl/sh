...
public class AtColor extends Activity
{
  ...
  public void changeCol(View paramView)
  {
    ...
    {
      this.simpleColorPickerView.setViewBgRes(2130903149, false);
    ...
    while (true)
    {
      this.changedColor = i;
      return;
      this.simpleColorPickerView.setViewBgRes(2130903150, false);
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    while (true)
    {
      if (DeviceListActivity.devicePid == "160fa2b3051a03e9160fa2b3051ac601")
        findViewById(2131558900).setVisibility(0);
      findViewById(2131558900).setVisibility(0);
      return;
  ...
  {
    ((TextView)findViewById(2131558901)).setText(paramInt + "%");
  }
  ...
  class ModeGridViewAdapter extends BaseAdapter
  {
    ...
    int[] reses = { 2130903158, 2130903159, 2130903160, 2130903161, 2130903163, 2130903162, 2130903164, 2130903165 };
 ...
 * Qualified Name:     com.ex.ltech.ct.AtColor
