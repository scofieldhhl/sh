...
public class SceneLastBussiness extends ModeBusiness
{
  ...
  public void initGalleryData()
  {
    ...
    this.imgList.add(BitmapFactory.decodeResource(this.pct.getResources(), 2130903102));
    this.imgList.add(BitmapFactory.decodeResource(this.pct.getResources(), 2130903103));
    this.imgList.add(BitmapFactory.decodeResource(this.pct.getResources(), 2130903104));
    this.imgList.add(BitmapFactory.decodeResource(this.pct.getResources(), 2130903105));
 ...
 * Qualified Name:     com.ex.ltech.bwct.SceneLastBussiness
