...
public class ActAddTiming extends MyBaseActivity
    ...
    private void findView() {
        ...
        this.tv_act_add_timing_jianbian_status = ((TextView) findViewById(R.id.tv_act_add_timing_aphal_status));
    }
    ...
    private void getMyIntent() {
        ...
        return;
        label470:
        this.tp_act_add_timing_hour.setSelected(Integer.parseInt(new SimpleDateFormat("HH").format(Long.valueOf(60000L + System.currentTimeMillis()))));
    ...
    protected void onCreate(Bundle paramBundle) {
        ...
        setContentView(R.layout.act_ct_add_timing);
        findView();
        init();
        setTitleView();
        setListener();
