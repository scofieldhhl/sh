...
public class AtLearnActivity$$ViewBinder<T extends AtLearnActivity>
  implements ButterKnife.ViewBinder<T>
{
  public void bind(ButterKnife.Finder paramFinder, T paramT, Object paramObject)
  {
    paramT.info3 = ((TextView)paramFinder.castView((View)paramFinder.findRequiredView(paramObject, 2131558813, "field 'info3'"), 2131558813, "field 'info3'"));
    paramT.info4 = ((TextView)paramFinder.castView((View)paramFinder.findRequiredView(paramObject, 2131558921, "field 'info4'"), 2131558921, "field 'info4'"));
    paramT.info5 = ((TextView)paramFinder.castView((View)paramFinder.findRequiredView(paramObject, 2131558922, "field 'info5'"), 2131558922, "field 'info5'"));
    paramT.info6 = ((TextView)paramFinder.castView((View)paramFinder.findRequiredView(paramObject, 2131558923, "field 'info6'"), 2131558923, "field 'info6'"));
    paramT.last = ((TextView)paramFinder.castView((View)paramFinder.findRequiredView(paramObject, 2131558924, "field 'last'"), 2131558924, "field 'last'"));
  ...
  public void unbind(T paramT)
  {
    ...
    paramT.save = null;
    paramT.info = null;
    paramT.learn_again = null;
    paramT.iv_center = null;
  }
}

/* Location:           E:\android逆向助手2——2\com.ex.ltech.led_1.9.7_197_dex2jar.jar
 * Qualified Name:     com.ex.ltech.remote.control.yaokong.AtLearnActivity..ViewBinder
