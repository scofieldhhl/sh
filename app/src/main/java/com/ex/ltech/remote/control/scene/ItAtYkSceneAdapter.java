...
public class ItAtYkSceneAdapter extends BaseAdapter
{
  private Context context;
  private LayoutInflater layoutInflater;
  private List<T> objects = new ArrayList();

  public ItAtYkSceneAdapter(Context paramContext)
  {
 ...
 * Qualified Name:     com.ex.ltech.remote.control.scene.ItAtYkSceneAdapter
