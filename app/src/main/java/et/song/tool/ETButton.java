  ...
  static
  {
    ...
    buttonOnFocusChangeListener = new OnFocusChangeListener()
    {
      public void onFocusChange(View paramView, boolean paramBoolean)
      {
        if (paramBoolean)
        {
          paramView.getBackground().setColorFilter(new ColorMatrixColorFilter(ETButton.ETBUTTON_SELECTED));
          paramView.setBackgroundDrawable(paramView.getBackground());
          return;
        }
        paramView.getBackground().setColorFilter(new ColorMatrixColorFilter(ETButton.ETBUTTON_NOT_SELECTED));
        paramView.setBackgroundDrawable(paramView.getBackground());
      }
    };
 ...
 * Qualified Name:     et.song.tool.ETButton
